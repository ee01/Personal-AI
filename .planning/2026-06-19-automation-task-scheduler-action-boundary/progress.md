...
- Read `AGENT.md`, `docs/features/index.md`, automation memory, `docs/progressing/to-verify.md`, and relevant memory workflow notes.
...
- Updated `docs/features/task_scheduler_api.md` and `docs/features/index.md`.
