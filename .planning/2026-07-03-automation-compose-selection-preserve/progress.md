...
- Read `AGENT.md`, `docs/progressing/to-verify.md`, automation memory, `docs/index.md`, `docs/features/assist.md`, Compose Assist controller/policy/test files, and direct-insert E2E.
...
- Updated `docs/features/assist.md` with the user-visible selection preservation behavior and this run's external-reference takeaway.
