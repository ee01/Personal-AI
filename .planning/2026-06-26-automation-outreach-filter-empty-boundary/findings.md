...
- `docs/memory_system.md` is current for Outreach list priorities, focus lane, card-level progress receipts, retry path, detail operation receipts, and failed refresh snapshot behavior.
