...
- Read `AGENT.md`, automation memory, memory quick-pass notes, `docs/index.md`, and `docs/progressing/to-verify.md`.
...
- Read `docs/memory_system.md`, `TimelinePage.vue`, `timelinePresentation.ts`, and timeline verifier/E2E files.
...
- Updated `docs/memory_system.md` and `docs/index.md` for the current timeline control-point behavior.
