...
- Read `AGENT.md`, `docs/progressing/to-verify.md`, `docs/index.md`, old root planning files, and the active `.planning` pointer.
...
- Implemented `智能录入范围回执` in `MemoryCoveragePage.vue`, added E2E assertions in `tools/verify-memory-coverage-e2e.mjs`, and updated `docs/features/memory_coverage_map.md` plus `docs/index.md`.
- Validation passed:
  ...
  - `git diff --check -- src/modals/components/MemoryCoveragePage.vue tools/verify-memory-coverage-e2e.mjs docs/features/memory_coverage_map.md docs/index.md .planning/.active_plan`
