...
- 2026-06-10: Added Dream Digest `dreamDigestScope` / `dreamDigestScopeReceipt`, rendered it in notice digests and backend notification previews, and updated focused tests plus `docs/features/memory_system.md`.
