...
- Read automation memory, `AGENT.md`, `docs/index.md`, `docs/progressing/to-verify.md`, relevant memory notes, planning skill instructions, and the personal-ai random-feature loop note.
...
- Updated `docs/features/doubao_bridge.md` and `docs/index.md` with the clicked-snapshot behavior.
