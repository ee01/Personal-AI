...
## Requirements
- Automation run: pick one random feature from `docs/features/index.md`, inspect docs/code, search related products and papers, incorporate relevant local `Personal AI` Reminders, implement low-decision unfinished or UX/bug improvements, verify as fully as practical, and update automation memory.
