...
- 已读 `AGENT.md`、`docs/features/index.md`、`docs/progressing/to-verify.md`、自动化记忆和相关 memory workflow。
...
- `docs/features/user_profile_system.md` 与 `docs/features/index.md`：同步记录导出中单飞边界。
