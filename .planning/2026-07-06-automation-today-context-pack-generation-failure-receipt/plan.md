...
- Selection note: chosen from a random `docs/features/index.md` shortlist after avoiding the freshest exact Topic / Outreach / Prompt Config / Project Dashboard / Storyline / Action Queue targets.
...
4. Update `docs/features/today_pilot.md` and `docs/features/index.md` with the concise current behavior.
