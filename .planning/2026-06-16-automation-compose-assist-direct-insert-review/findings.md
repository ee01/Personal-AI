...
- Randomly selected feature from `docs/features/index.md`: `回复助手直接插入`.
...
- `docs/features/compose_assist.md` is current for the selected direct-insert path and already documents hover preview, insert-only semantics, undo, write-failure receipts, source-route receipts, review gating, and high-risk evidence redaction.
