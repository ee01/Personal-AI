...
- `docs/progressing/to-verify.md` is empty, so this run selected a fresh feature from `docs/features/index.md`.
...
4. Update `docs/features/memory_coverage_map.md` and `docs/features/index.md` concisely.
