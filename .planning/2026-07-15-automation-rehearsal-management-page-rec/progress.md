...
- Random sample from `docs/features/index.md` produced `Rehearsal 管理页`; selected it after avoiding the freshest exact/family automation targets.
...
- Updated `docs/features/rehearsal.md` and `docs/features/index.md` with concise evidence-row provenance wording.
- Verification passed:
