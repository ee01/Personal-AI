...
- Read repo and automation instructions, memory guidance, `AGENT.md`, `docs/index.md`, and `docs/progressing/to-verify.md`.
...
- Updated `docs/features/user_profile_system.md` and the `用户画像导出` row in `docs/index.md`.
- Validation passed:
