...
- Inspected `docs/features/memory_system.md`, `src/modals/components/ActionQueue.vue`, `tools/verify-action-queue-e2e.mjs`, `src/services/MemoryServiceClient.ts`, and package scripts.
...
- Updated `docs/features/memory_system.md` with the user-visible stale snapshot boundary.
