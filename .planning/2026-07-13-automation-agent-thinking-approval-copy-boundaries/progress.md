...
- Read `AGENT.md`, automation memory, `docs/index.md`, `docs/progressing/to-verify.md`, memory guidance, and the planning skill.
...
- Updated `docs/features/agent_thinking.md` and `docs/index.md` for the 2026-07-13 button-boundary behavior.
