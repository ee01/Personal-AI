...
- Read `AGENT.md`, `docs/index.md`, automation memory, `docs/progressing/to-verify.md`, active planning state, and worktree status.
...
- Updated `docs/features/meeting_native_join.md` and the Native Join row in `docs/index.md`.
