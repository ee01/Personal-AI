...
- [x] Read `AGENT.md`, `docs/index.md`, `docs/progressing/to-verify.md`, automation memory, and relevant memory registry hints.
...
- `git diff --check -- src/meeting-shell/SpeechTab.tsx desktop-app/scripts/meeting-pilot-scene2-runtime-check.mjs docs/features/meeting_pilot.md docs/index.md .planning/.active_plan .planning/2026-07-08-automation-meeting-pilot-rc-transcript-boundary`
