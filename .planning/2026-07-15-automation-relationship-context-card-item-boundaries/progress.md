...
- Read `AGENT.md`, `docs/index.md`, `docs/progressing/to-verify.md`, automation memory, and relevant memory registry entries.
...
- Updated `docs/features/relationship_radar.md` and the `人脉关系 Context Card` row in `docs/index.md`.
- Validation passed:
  ...
  - `git diff --check -- src/modals/components/RelationshipRadarPage.vue tools/verify-relationship-radar-e2e.mjs docs/features/relationship_radar.md docs/index.md .planning/.active_plan .planning/2026-07-15-automation-relationship-context-card-item-boundaries`
