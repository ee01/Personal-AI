...
- Randomly selected `覆盖聚合 API` from `docs/features/index.md` sample, avoiding very recent exact feature surfaces.
...
- Updated `tools/verify-memory-coverage-e2e.mjs` with slice endpoint fixtures and assertions for the new panel; updated `docs/features/memory_coverage_map.md` and `docs/features/index.md`.
