...
- Read `AGENT.md`, automation memory, random-loop memory notes, `docs/progressing/to-verify.md`, and `docs/index.md`.
...
- Updated `docs/features/memory_coverage_map.md` and `docs/index.md` for the new slice contract.
