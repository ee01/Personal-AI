...
- 读取 `AGENT.md`、`docs/features/index.md`、`docs/progressing/to-verify.md`、自动化记忆和历史 planning 文件。
...
- 更新 `docs/features/custom_prompts.md` 和 `docs/features/index.md` 的用户可感知行为说明。
- 验证通过：
