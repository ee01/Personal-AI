...
| 2 | completed | Select a non-fresh exact feature target from `docs/index.md` and inspect Quick Ask voice docs/code/tests |
...
- Existing worktree is broadly dirty. Keep edits scoped to `desktop-app/app/quick-ask.js`, `desktop-app/app/i18n.js`, `desktop-app/scripts/quick-ask-status-card-check.mjs`, `docs/features/doubao_bridge.md`, `docs/index.md`, and this planning directory.
