# 新能力：Research Trail Synthesizer / 研究足迹合成器

> Codex 会话标题建议：`新能力：研究足迹合成器`  
> 状态：规划草案；本轮只写 plan 和 demo，不改运行时代码  
> Demo：[research-trail-synthesizer-demo.html](./research-trail-synthesizer-demo.html)

## 一句话结论

设计一个新的 Personal AI 能力：**研究足迹合成器**。
