...
| Roadmap 打开静默刷新 Jira | Personal Roadmap | [personal_roadmap.md](./features/personal_roadmap.md) | 扩展独占读；含依赖 ticket 缓存；主任务/子任务都镜像 status；`refresh_from_jira` 10 分钟 TTL；不进 ticker；本地未回写排期先推 Jira，旧 Target 不盖 bar |
