...
| ----------------------------- | --------------- | --------------------------------------------------------------------------------------------- |
| `mobile_briefing`（近期重点） | 普通笔记        | `帮我把 Personal AI (私人 AI) 的近期重点记到随手记里，方便我后面查看：项目 A 卡在接口联调，本周优先处理发布问题。` |
| `reminder_sync`（提醒）       | 待办清单        | `帮我把 Personal AI (私人 AI) 的待办记到随手记里：周五下班前交周报。`                         |
