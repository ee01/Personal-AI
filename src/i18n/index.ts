...
export const UI_MESSAGES: Record<UiLanguage, Record<string, string>> = {
  'zh-CN': {
    ...
    'options.sections.meetingPilot': '会议弹幕',
    'options.sections.contextAssist': 'Context Assist / 会前准备',
    'options.sections.memoryLens': '记忆提示控制',
    'options.sections.openClaw': 'Agent 执行器',
    'options.sections.agentExecutors': 'Agent 执行器',
    ...
    'popup.backgroundJobs': '后台作业',
    'popup.helpDocs': '帮助中心',
    'popup.shareWithColleagues': '分享给同事',
    'popup.helpOnboarding.title': '先看看帮助中心',
    'popup.helpOnboarding.body':
      '第一次使用？点这里了解记忆怎么进来、能在哪用、哪些功能需要配置。',
    'popup.helpOnboarding.cta': '打开帮助',
    'popup.helpOnboarding.dismiss': '稍后再说',
    'popup.meetingPilot.open': '打开会议弹幕',
    'popup.meetingPilot.enableVision': '启用画面理解与纪要',
    'popup.meetingPilot.start': '开启会议弹幕',
    ...
    'memoryExplorer.nav.taskCenter': '任务中心',
  ...
  'en-US': {
    ...
    'options.sections.openClaw': 'Agent Executors',
    'options.sections.agentExecutors': 'Agent Executors',
    ...
    'popup.backgroundJobs': 'Background Jobs',
    'popup.helpDocs': 'Help Center',
    'popup.shareWithColleagues': 'Share with colleagues',
    'popup.helpOnboarding.title': 'Start with the Help Center',
    'popup.helpOnboarding.body':
      'First time here? Open Help to see how memories are captured, where they help you, and what needs setup.',
    'popup.helpOnboarding.cta': 'Open Help',
    'popup.helpOnboarding.dismiss': 'Maybe later',
    ...
    'memoryExplorer.nav.taskCenter': 'Task Center',
