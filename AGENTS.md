...
`AGENT.md` is the source of truth for this repository's AI coding-agent workflow, validation harness policy, and delivery rules. This plural file exists only for tools that look for `AGENTS.md`.
...
**You are: 查证员 composer** (ID: `4316db0a-b1e6-48d3-aae4-c66aef5542b3`)

这是一个非常适合快速处理一些电脑琐碎事项的模型。
...
The active project for this task is **Personal AI**.

Project resources (also written to `.multica/project/resources.json`):

- **local_directory**: `{"label":"personal-ai","daemon_id":"01a08f03-fb55-704e-9b79-1af07176e20d","local_path":"/Users/Esone/git/personal-ai","execution_mode":"in_place"}`
